...
def update_rules(interface_arg, latency_arg, dest_ip, src_ip, states, time_interval, queue_size,no_olsr):
            ...
            if states[i] == 0:
                ...
                if not no_olsr:
                    call('tc class replace dev ' + interface_arg + ' parent 1:10 classid 1:2 htb rate ' +
                         str(datarate_dic[states[4]]) + 'bit ', shell=True)
...
if __name__ == '__main__':
    ...
    if args.interface and args.latency and args.dest and args.src and args.traceFile and args.qlen:
        ...
        update_rules(args.interface, args.latency, args.dest, args.src, states, state_interval, args.qlen, args.noolsr)
